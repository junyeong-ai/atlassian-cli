...
[![Rust](https://img.shields.io/badge/rust-1.97.0%2B%20(2024%20edition)-orange?style=flat-square&logo=rust)](https://www.rust-lang.org)
...
cd atlassian-cli
cargo build --release   # toolchain pinned by rust-toolchain.toml (1.97.0)
...
**Requirement**: Rust 1.97.0+ (소스 빌드 시).
